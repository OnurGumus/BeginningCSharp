...
namespace Lab4
{
    class Game
    {
        ...
        public async Task<GameScore> GetHighScore()
        {
            ...
            var data = await httpClient.GetAsync("http://localhost:5000/api/GameScore");
        ...
        public async Task SaveHighScore()
        {
            ...
            var httpClient = new HttpClient();
            await httpClient.PostAsJsonAsync("http://localhost:5000/api/GameScore", gameScore);
        }
        ...
        public async Task<string> MakeGuess(int guess)
        {
            ...
            await SaveHighScore();
            return $"Congrats! You have found int {guessCount} attempts!";
